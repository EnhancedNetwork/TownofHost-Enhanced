...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0721.200.11000"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Canary 11";
    public const string SupportedVersionAU = "2024.6.18";

    /******************* Change one of the three variables to true before making a release. *******************/
    public static readonly bool Canary = true; // ACTIVE - Latest: V2.0.0 11
