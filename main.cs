...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0528.200.000230"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Dev 23";
    ...
    public static readonly bool devRelease = true; // INACTIVE - Latest: V2.0.0 Dev 23
