...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0519.200.000150"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Dev 15";
    ...
    public static readonly bool devRelease = true; // INACTIVE - Latest: V2.0.0 Dev 15
