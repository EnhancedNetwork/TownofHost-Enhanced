...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0928.210.00152"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.1.0 Alpha 15 Hotfix 2";
    public const string SupportedVersionAU = "2024.8.13";

    /******************* Change one of the three variables to true before making a release. *******************/
    public static readonly bool devRelease = true; // Latest: V2.1.0 Alpha 15 Hotfix 2
