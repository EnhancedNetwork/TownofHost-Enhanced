...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.1008.210.020000"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.1.0 Beta 2";
    ...
    public static readonly bool canaryRelease = true; // Latest: V2.1.0 Beta 2
