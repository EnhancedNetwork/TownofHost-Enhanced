...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0609.200.010000"; // YEAR.MMDD.VERSION.CANARYDEV
    ...
    public static readonly bool Canary = true; // ACTIVE - Latest: V2.0.0 Canary 1
