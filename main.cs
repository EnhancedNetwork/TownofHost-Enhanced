...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2025.1023.241.00001"; // YEAR.MMDD.VERSION.CANARYDEV
    ...
    public static readonly bool devRelease = true; // Discontinued, use Beta instead
    ...
    public static PlayerControl[] AllAlivePlayerControls
    {
        get
        {
            ...
            foreach (var pc in PlayerControl.AllPlayerControls)
            {
                if (pc == null || pc.PlayerId == 255 || pc.notRealPlayer || !pc.IsAlive() || pc.Data.Disconnected || Pelican.IsEaten(pc.PlayerId)) continue;
                result[i++] = pc;
            }
