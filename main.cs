...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0519.200.000140"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Dev 14";
    ...
    public static readonly bool devRelease = true; // INACTIVE - Latest: V2.0.0 Dev 14
