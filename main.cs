...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0606.200.000250"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Dev 25 Niko";
    public static readonly string SupportedVersionAU = "2024.3.5"; // Also 2024.6.4

    public static string FakeGitInfo = "01c7aef8(Dev25)";
    ...
    public static readonly bool devRelease = true; // INACTIVE - Latest: V2.0.0 Dev 25
