...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2024.0610.200.020000"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.0.0 Canary 2";
    public static readonly string SupportedVersionAU = "2024.3.5"; // Also 2024.6.4

    /******************* Change one of the three variables to true before making a release. *******************/
    public static readonly bool Canary = true; // ACTIVE - Latest: V2.0.0 Canary 2
