...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2025.0306.230.000020"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "2.3.0 Alpha 2";
    public const string SupportedVersionAU = "2024.10.29"; // Changed becasue Dark theme works at this version.

    /******************* Change one of the three variables to true before making a release. *******************/
    public static readonly bool devRelease = false; // Latest: V2.3.0 Alpha 2
