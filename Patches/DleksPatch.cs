...
class AllMapIconsPatch
{
    ...
    public static void Postfix_AllMapIcons(GameStartManager __instance)
    {
        ...
        {
            if (Main.HideNSeekOptions.MapId == 3)
            {
        ...
        DleksIncon.MapImage = Utils.LoadSprite($"TOHE.Resources.Images.DleksBanner-Wordart.png", 100f);
        DleksIncon.NameImage = Utils.LoadSprite($"TOHE.Resources.Images.DleksBanner.png", 100f);
