    ...
    private static bool CreateSettingsPrefix(GameOptionsMenu __instance)
    {
        ...
        System.Collections.IEnumerator CoRoutine()
        {
            ...
            for (int index = 0; index < OptionItem.AllOptions.Count; index++)
            {
                ...
                var enabled = (!GameSettingMenuPatch.SearchWinners.Any() || (GameSettingMenuPatch.SearchWinners.Contains(option) || GameSettingMenuPatch.SearchWinners.Contains(option.Parent))) 
