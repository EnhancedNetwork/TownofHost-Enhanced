...
{
    // For some reason RpcClose is not called but the meeting still ends
    // Idk what code can skip RpcClose and do Close. Wtf
    public static void Postfix()
    {
        Logger.Info("MeetingHud.Close is being called", "MeetingHudClosePatch");
    }
}
