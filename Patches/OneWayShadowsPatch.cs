...
public static class OneWayShadowsIsIgnoredPatch
{
    ...
    {
        var amDesyncImpostor = PlayerControl.LocalPlayer.HasDesyncRole() || Main.PlayerStates[PlayerControl.LocalPlayer.PlayerId].IsNecromancer || Main.PlayerStates[PlayerControl.LocalPlayer.PlayerId].IsRandomizer;
