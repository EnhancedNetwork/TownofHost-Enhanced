...
internal class ChatCommands
{
    ...
    public static string FixRoleNameInput(string text)
    {
        ...
        return text switch
        {
            ...
            // 后面的别名均对应附加简写
            // 附加职业
            "絕境者" or "绝境者" or "" or "" => GetString("LastImpostor"),
            "超頻" or "超频波" or "" or "" => GetString("Overclocked"),
            "戀人" or "恋人" => GetString("Lovers"),
            "叛徒" or "" or "" => GetString("Madmate"),
            "海王" or "" or "" => GetString("Ntr"),
            "觀察者" or "窥视者" or "" or "" => GetString("Watcher"),
            "閃電俠" or "闪电侠" or "" or "" => GetString("Flashman"),
            "持燈人" or "火炬" or "" or "" => GetString("Torch"),
            "靈媒" or "灵媒" or "" or "" => GetString("Seer"),
            "破平者" or "破平者" or "" or "" => GetString("Brakar"),
            "膽小鬼" or "胆小鬼" or "" or "" => GetString("Oblivious"),
            "視障" or "迷幻者" or "" or "" => GetString("Bewilder"),
            "墨鏡" or "患者" or "" or "" => GetString("Sunglasses"),
            "加班狂" or "加班狂" or "" or "" => GetString("Workhorse"),
            "蠢蛋" or "" or "" => GetString("Fool"),
            "復仇者" or "复仇者" or "" or "" => GetString("Avanger"),
            "Youtuber" or "UP主" or "" or "" => GetString("Youtuber"),
            "利己主義者" or "利己主义者" or "" or "" => GetString("Egoist"),
            "竊票者" or "窃票者" or "" or "" => GetString("TicketsStealer"),
            "雙重人格" or "双重人格" or "" or "" => GetString("DualPersonality"),
            "保險箱" or "宝箱怪" or "" or "" => GetString("Mimic"),
            "賭怪" or "赌怪" or "" or "" => GetString("Guesser"),
            "死神" or "死神" or "" or "" => GetString("Necroview"),
            "長槍" or "持枪" or "" or "" => GetString("Reach"),
            "魅魔小弟" or "" or "" => GetString("Charmed"),
            "乾淨" or "干净" or "" or "" => GetString("Cleansed"),
            "誘餌" or "诱饵" or "" or "" => GetString("Bait"),
            "陷阱師" or "陷阱师" or "" or "" => GetString("Trapper"),
            "被感染" or "感染" or "" or "" => GetString("Infected"),
            "防賭" or "不可被赌" or "" or "" => GetString("Onbound"),
            "反擊者" or "回弹者" or "" or "" => GetString("Rebound"),
            "騎士" or "骑士" or "" or "" => GetString("Knighted"),
            "漠視" or "不受重视" or "" or "" => GetString("Unreportable"),
            "被傳染" or "传染性" or "" or "" => GetString("Contagious"),
            "盜賊" or "盗贼" or "" or "" => GetString("Rogue"),
            "幸運" or "幸运加持" or "" or "" => GetString("Lucky"),
            "倒霉" or "倒霉蛋" or "" or "" => GetString("Unlucky"),
            "虛無" or "无效投票" or "" or "" => GetString("VoidBallot"),
            "敏感" or "意识到" or "" or "" => GetString("Aware"),
            "嬌嫩" or "脆弱" or "" or "" => GetString("Fragile"),
            "專業" or "双重猜测" or "" or "" => GetString("DoubleShot"),
            "流氓" or "流氓" or "" or "" => GetString("Rascal"),
            "無魂" or "没有灵魂" or "" or "" => GetString("Soulless"),
            "墓碑" or "" or "" => GetString("Gravestone"),
            "懶人" or "懒人" or "" or "" => GetString("Lazy"),
            "驗屍" or "尸检" or "" or "" => GetString("Autopsy"),
            "忠誠" or "忠诚" or "" or "" => GetString("Loyal"),
            "惡靈" or "恶灵" or "" or "" => GetString("EvilSpirit"),
            "狼化" or "招募" or "" or "" => GetString("Recruit"),
            "被仰慕" or "仰慕" or "" or "" => GetString("Admired"),
            "發光" or "光辉" or "" or "" => GetString("Glow"),
            "病態" or "患病" or "" or "" => GetString("Diseased"),
            "健康" or "" or "" => GetString("Antidote"),
            "固執者" or "固执者" or "" or "" => GetString("Stubborn"),
            "無影" or "迅捷" or "" or "" => GetString("Swift"),
            "反噬" or "食尸鬼" or "" or "" => GetString("Ghoul"),
            "嗜血者" or "" or "" => GetString("Bloodlust"),
            "獵夢者" or "梦魇" or "" or "" => GetString("Mare"),
            "地雷" or "爆破者" or "" or "" => GetString("Burst"),
            "偵察員" or "侦察员" or "" or "" => GetString("Sleuth"),
            "笨拙" or "笨蛋" or "" or "" => GetString("Clumsy"),
            "敏捷" or "" or "" => GetString("Nimble"),
            "規避者" or "规避者" or "" or "" => GetString("Circumvent"),
            "名人" or "网络员" or "" or "" => GetString("Cyber"),
            "維修員" or "维修员" or "" or "" => GetString("Repairman"),
            "焦急者" or "" or "" => GetString("Hurried"),
            "OIIAI" or "" or "" => GetString("Oiiai"),
            "順從者" or "影响者" or "" or "" => GetString("Influenced"),
