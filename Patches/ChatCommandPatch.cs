...
internal class ChatCommands
{
    ...
    public static string FixRoleNameInput(string text)
    {
        ...
        return text switch
        {
            ...
            "神" or "神" => GetString("God"),
            "冤罪師" or "冤罪师" => GetString("Innocent"),
            "鵜鶘" or "鹈鹕" => GetString("Pelican"),
            "革命家" or "革命家" => GetString("Revolutionist"),
            "單身狗" or "FFF团" => GetString("FFF"),
            "柯南" or "柯南" => GetString("Konan"),
            "玩家" or "玩家" => GetString("Gamer"),
            "潛藏者" or "潛藏者" => GetString("DarkHide"),
            "工作狂" or "工作狂" => GetString("Workaholic"),
            "集票者" or "集票者" => GetString("Collector"),
            ...
            "跟班" or "跟班" => GetString("Sidekick"),
            "巫婆" or "巫婆" => GetString("NWitch"),
            "追隨者" or "赌徒" => GetString("Totocalcio"),
            "魅魔" or "魅魔" => GetString("Succubus"),
            ...
            "強盜" or "强盗" => GetString("Bandit"),
            "分身者" or "分身者" => GetString("Doppelganger"),
            "受虐狂" or "受虐狂" => GetString("Masochist"),
            "賭神" or "末日赌怪" => GetString("Doomsayer"),
            "裹屍布" or "裹尸布" => GetString("Shroud"),
            "月下狼人" or "月下狼人" => GetString("Werewolf"),
