...
internal class ChatCommands
{
    ...
    public static string FixRoleNameInput(string text)
    {
        ...
        return text switch
        {
            ...
            "邪惡的追踪者" or "邪恶追踪者" => GetString("EvilTracker"),
            ...
            "資本主義者" or "资本家" => GetString("Capitalism"),
            "歹徒" or "教父" => GetString("Gangster"),
            "清潔工" or "清理工" => GetString("Cleaner"),
            "球狀閃電" or "球状闪电" => GetString("BallLightning"),
            "貪婪者" or "贪婪者" => GetString("Greedier"),
            "被詛咒的狼" or "呪狼" => GetString("CursedWolf"),
            "換魂師" or "夺魂者" => GetString("ImperiusCurse"),
            "快槍手" or "快枪手" => GetString("QuickShooter"),
            "隱蔽者" or "隐蔽者" => GetString("Camouflager"),
            "抹除者" => GetString("Eraser"),
            "肢解者" => GetString("OverKiller"),
            "劊子手" or "刽子手" => GetString("Hangman"),
            "隱身人" or "隐匿者" => GetString("Swooper"),
            ...
            "分散者" => GetString("Disperser"),
            "抑鬱者" or "抑郁者" => GetString("Inhibitor"),
            "破壞者" or "破坏者" => GetString("Saboteur"),
            "議員" or "邪恶法官" => GetString("Councillor"),
            "眩暈者" or "眩晕者" => GetString("Dazzler"),
            "簽約人" or "死亡契约" => GetString("Deathpact"),
            "吞噬者" => GetString("Devourer"),
            "軍師" or "军师" => GetString("EvilDiviner"),
            "化型者" or "化形者" => GetString("Morphling"),
            "躁動者" or "龙卷风" => GetString("Twister"),
            "策畫者" or "潜伏者" => GetString("Lurker"),
            "罪犯" => GetString("Convict"),
            "幻想家" => GetString("Visionary"),
            "逃亡者" => GetString("Refugee"),
            "潛伏者" or "失败者" => GetString("Underdog"),
            "賭博者" or "速度者" => GetString("Ludopath"),
            ...
            "壞迷你船員" or "坏迷你船员" => GetString("EvilMini"),
            ...
            // 中立阵营职业
            "小丑" => GetString("Jester"),
            "縱火犯" or "纵火犯" => GetString("Arsonist"),
            "焚燒狂" or "焚烧狂" => GetString("Pyromaniac"),
            "獵人" or "猎人" => GetString("Huntsman"),
            "恐怖分子" => GetString("Terrorist"),
            "暴民" or "处刑人" => GetString("Executioner"),
            "律師" or "律师" => GetString("Lawyer"),
            "投機主義者" or "投机者" => GetString("Opportunist"),
            "瑪利歐" or "马里奥" => GetString("Marion"),
            "豺狼" or "豺狼" => GetString("Jackal"),
            "神" => GetString("God"),
            "冤罪師" or "冤罪师" => GetString("Innocent"),
            "鵜鶘" or "鹈鹕" => GetString("Pelican"),
            "革命家" => GetString("Revolutionist"),
            "單身狗" or "FFF团" => GetString("FFF"),
            "柯南" => GetString("Konan"),
            "玩家" => GetString("Gamer"),
            "潛藏者" => GetString("DarkHide"),
            "工作狂" => GetString("Workaholic"),
            "集票者" => GetString("Collector"),
            ...
            "超頻" or "超频波" => GetString("Overclocked"),
            "戀人" or "恋人" => GetString("Lovers"),
            "叛徒" => GetString("Madmate"),
            "海王" => GetString("Ntr"),
            "觀察者" or "窥视者" => GetString("Watcher"),
            "閃電俠" or "闪电侠" => GetString("Flashman"),
            "持燈人" or "火炬" => GetString("Torch"),
            "靈媒" or "灵媒" => GetString("Seer"),
            "破平者" or "破平者" => GetString("Brakar"),
            "膽小鬼" or "胆小鬼" => GetString("Oblivious"),
            "視障" or "迷幻者" => GetString("Bewilder"),
            "墨鏡" or "患者" => GetString("Sunglasses"),
            "加班狂" or "加班狂" => GetString("Workhorse"),
            "蠢蛋" => GetString("Fool"),
            "復仇者" or "复仇者" => GetString("Avanger"),
            "Youtuber" or "UP主" => GetString("Youtuber"),
            "利己主義者" or "利己主义者" => GetString("Egoist"),
            "竊票者" or "窃票者" => GetString("TicketsStealer"),
            "雙重人格" or "双重人格" => GetString("DualPersonality"),
            "保險箱" or "宝箱怪" => GetString("Mimic"),
            "賭怪" or "赌怪" => GetString("Guesser"),
            "死神" or "死神" => GetString("Necroview"),
            ...
            "反擊者" or "回弹者" => GetString("Rebound"),
            "騎士" or "骑士" => GetString("Knighted"),
            "漠視" or "不受重视" => GetString("Unreportable"),
            ...
            "狼化" or "招募" => GetString("Recruit"),
            "被仰慕" or "仰慕" => GetString("Admired"),
            "發光" or "光辉" => GetString("Glow"),
            "病態" or "患病" => GetString("Diseased"),
            "健康" => GetString("Antidote"),
            "固執者" or "固执者" => GetString("Stubborn"),
            "無影" or "迅捷" => GetString("Swift"),
            "反噬" or "食尸鬼" => GetString("Ghoul"),
            "嗜血者" => GetString("Bloodlust"),
            "獵夢者" or "梦魇" => GetString("Mare"),
            "地雷" or "爆破者" => GetString("Burst"),
            "偵察員" or "侦察员" => GetString("Sleuth"),
            "笨拙" or "笨蛋" => GetString("Clumsy"),
            "敏捷" => GetString("Nimble"),
            "規避者" or "规避者" => GetString("Circumvent"),
            "名人" or "网络员" => GetString("Cyber"),
            "維修員" or "维修员" => GetString("Repairman"),
            "焦急者" => GetString("Hurried"),
            "OIIAI" => GetString("Oiiai"),
            "順從者" or "影响者" => GetString("Influenced"),
