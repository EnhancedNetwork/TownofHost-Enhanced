...
namespace TOHE.Roles.Neutral
{
    public static class Solsticer
    {
        ...
        {
            foreach (var pc in Main.AllAlivePlayerControls.Where(x => x.Is(CustomRoles.Solsticer)))
            {
        ...
        {
            var TotalPlayer = Main.PlayerStates.Where(x => x.Value.deathReason != PlayerState.DeathReason.Disconnected).Count();
