...
internal class Pursuer : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        PursuerSkillCooldown = FloatOptionItem.Create("PursuerSkillCooldown", new(2.5f, 180f, 2.5f), 20f, TabGroup.NeutralRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Pursuer])
