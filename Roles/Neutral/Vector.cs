...
namespace TOHE.Roles.Neutral
{
    internal class Vector : RoleBase
    {
        ...
        //==================================================================\\
        public static OptionItem VectorVentNumWin;
        public static OptionItem VectorVentCD;

        public static readonly Dictionary<byte, int> VectorVentCount = [];
        ...
        public override void OnEnterVent(PlayerControl pc, Vent vent)
        {
            ...
            if (AmongUsClient.Instance.AmHost && VectorVentCount[pc.PlayerId] >= VectorVentNumWin.GetInt())
            {
