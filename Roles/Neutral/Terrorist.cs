...
internal class Terrorist : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        CanTerroristSuicideWin = BooleanOptionItem.Create("CanTerroristSuicideWin", false, TabGroup.NeutralRoles, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Terrorist]);
        TerroristCanGuess = BooleanOptionItem.Create("CanGuess", true, TabGroup.NeutralRoles, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Terrorist]);
