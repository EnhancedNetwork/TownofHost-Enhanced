...
internal class God : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        NotifyGodAlive = BooleanOptionItem.Create("NotifyGodAlive", true, TabGroup.NeutralRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.God]);
        CanGuess = BooleanOptionItem.Create("CanGuess", false, TabGroup.NeutralRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.God]);
    }
