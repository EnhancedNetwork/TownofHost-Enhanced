    ...
    public bool TrialMsg(PlayerControl pc, string msg, bool isUI = false)
    {
        ...
        else if (operate == 2)
        {
            ...
            if (target != null)
            {
                ...
                else if (target.Is(CustomRoles.Admired)) judgeSuicide = true;
                ...
                else if (pc.Is(CustomRoles.Rebel) || pc.IsAnySubRole(x => x.IsConverted() && x != CustomRoles.Soulless)) judgeSuicide = false;
