    ...
    public bool TrialMsg(PlayerControl pc, string msg, bool isUI = false)
    {
        ...
        else if (operate == 2)
        {
            ...
            if (target != null)
            {
                ...
                else if ((target.GetCustomRole().IsMadmateV4Narc() || target.Is(CustomRoles.Madmate)) && CanTrialMadmate.GetBool()) judgeSuicide = false;
                ...
                else if (target.GetCustomRole().IsImpostorV4Narc()) judgeSuicide = false;
                else
                {
