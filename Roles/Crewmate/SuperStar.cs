...
internal class SuperStar : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        EveryOneKnowSuperStar = BooleanOptionItem.Create("EveryOneKnowSuperStar", true, TabGroup.CrewmateRoles, false)
    ...
    public override string GetSuffix(PlayerControl seer, PlayerControl seen = null, bool isForMeeting = false)
            => seen.Is(CustomRoles.SuperStar) && EveryOneKnowSuperStar.GetBool() ? ColorString(GetRoleColor(CustomRoles.SuperStar), "★") : "";
