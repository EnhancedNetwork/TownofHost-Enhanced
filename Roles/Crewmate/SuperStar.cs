...
namespace TOHE.Roles.Crewmate
{
    internal class SuperStar : RoleBase
    {
        ...
        public override string GetSuffix(PlayerControl seer, PlayerControl seen = null, bool isForMeeting = false)
                => seer.Is(CustomRoles.SuperStar) && SuperStar.EveryOneKnowSuperStar.GetBool() ? ColorString(GetRoleColor(CustomRoles.SuperStar), "★") : "";
        ...
        {
            return target.Is(CustomRoles.SuperStar) && SuperStar.EveryOneKnowSuperStar.GetBool();
        }
    }
}
