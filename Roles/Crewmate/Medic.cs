...
internal class Medic : RoleBase
{
    ...
    private bool CheckKillButton() => AbilityLimit > 0;
    ...
    public override string GetProgressText(byte playerId, bool comms) 
        => GiveTasks ? string.Empty : ColorString(CheckKillButton() ? GetRoleColor(CustomRoles.Medic).ShadeColor(0.25f) : Color.gray, $"({AbilityLimit})");
