...
public static class Madmate
{
    ...
    {
        return pc && !pc.Is(CustomRoles.Madmate) && (pc.GetCustomRole().IsCrewmate() || (forAdmirer && pc.GetCustomRole().IsNeutral()) || (pc.GetCustomRole().IsCoven() && (forAdmirer || (Gangster.CovenCanBeMadmate.GetBool() && forGangster))))
