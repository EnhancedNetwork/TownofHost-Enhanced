...
internal class SoulCatcher : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        ShapeSoulCatcherShapeshiftDuration = FloatOptionItem.Create("ShapeshiftDuration", new(2.5f, 180f, 2.5f), 300, TabGroup.ImpostorRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.SoulCatcher])
            .SetValueFormat(OptionFormat.Seconds);
        SoulCatcherShapeshiftCooldown = FloatOptionItem.Create("ShapeshiftCooldown", new(1f, 180f, 1f), 15f, TabGroup.ImpostorRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.SoulCatcher])
            .SetValueFormat(OptionFormat.Seconds);
    }
