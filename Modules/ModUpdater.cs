...
public class ModUpdater
{
    ...
    private static void CheckCustomRegions()
    {
        ...
        foreach (var region in regions)
        {
            if (region.Name.Contains("Niko233(NA_US)", StringComparison.OrdinalIgnoreCase) || region.Name.Contains("NikoCat233", StringComparison.OrdinalIgnoreCase) || region.Name.Contains("Niko233(EU2)", StringComparison.OrdinalIgnoreCase))
            {
                forceUpdate = true;
                break;
            }
