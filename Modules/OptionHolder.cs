    ...
    private static System.Collections.IEnumerator CoLoadOptions()
    {
        ...
        */
        ...
        BypassRateLimitAC = BooleanOptionItem.Create(60049, "BypassRateLimitAC", true, TabGroup.SystemSettings, false)
            .SetHeader(true);
        MaxSpiltReliablePacketsPerTick = IntegerOptionItem.Create(60048, "MaxSpiltReliablePacketsPerTick", new(1, 100, 1), 10, TabGroup.SystemSettings, false)
            .SetValueFormat(OptionFormat.Pieces)
            .SetParent(BypassRateLimitAC);
        MaxSpiltNonePacketsPerTick = IntegerOptionItem.Create(60047, "MaxSpiltNonePacketsPerTick", new(1, 100, 1), 10, TabGroup.SystemSettings, false)
            .SetValueFormat(OptionFormat.Pieces)
            .SetParent(BypassRateLimitAC);
