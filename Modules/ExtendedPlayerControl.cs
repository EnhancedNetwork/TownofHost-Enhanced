...
static class ExtendedPlayerControl
{
    ...
    public static bool CantUseVent(this PlayerControl player, int ventId) => !player.CanUseVents() || CustomRoleManager.BlockedVentsList.TryGetValue(player.PlayerId, out var blockedVents) && blockedVents.Contains(ventId);
