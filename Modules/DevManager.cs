...
public static class DevManager
{
    ...
    public static void Init()
    {
        ...
        DevUserList.Add(new(code: "motelchief#4112", color: "#9e2424", userType: "s_cr", tag: "Pierdol", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: "Drakos"));
        // gonna have this up untill canary release cuz Istg I can't trust this API %&#"&!
